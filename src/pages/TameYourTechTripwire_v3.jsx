...
const FAQS = [
  ...
  {
    q: "What happens after the month?",
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#F5EDE0", color: "#22291F" }}>
      ...
      <section className="max-w-3xl mx-auto px-6 pt-16 pb-14 text-center">
        ...
        >
          One tech problem,{" "}
          <span style={{ color: "#3D7267", fontStyle: "italic" }}>solved this month</span>.
        </h1>
        ...
        <div>
          <a
            ...
            style={{ background: "#3D7267", color: "#F5EDE0" }}
          >
            {isExpired ? "See what's still available" : "Start my $7.42 trial"} <ArrowRight size={16} />
          </a>
          <p className="text-xs opacity-60 mt-3">
            After a month, roll into Tame Your Tech at $150/mo — or don't. No contracts either way.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-16">
        <div className="max-w-4xl mx-auto">
          <h2
            ...
            style={{ fontFamily: "'Playfair Display', serif", fontWeight: 600 }}
          >
            Here's exactly how the month goes.
          </h2>
        ...
        <div className="max-w-4xl mx-auto grid sm:grid-cols-2 gap-5">
          ...
          >
            ...
            <ul className="space-y-2 text-sm">
              {[
                "One small tech task, fully handled — not just advice",
                "Direct email or async video support",
                "Turnaround within a month, possibly a week",

    ...
    <>
      ...
      <nav className="tyt-nav" aria-label="Site navigation">
        <div className="tyt-nav-inner">
          ...
          <a href="#tyt-checkout" className="tyt-btn tyt-btn-primary tyt-nav-cta">See plans →</a>
        </div>
      </nav>
      ...
      <div className={`tyt-buybar${showBar ? " show" : ""}`} aria-hidden={!showBar}>
        <div className="tyt-buybar-inner">
          ...
          <a href="#tyt-checkout" className="tyt-btn tyt-btn-primary">See plans →</a>
        </div>
      </div>
      ...
      <section className="tyt-hero" id="tyt-hero">
        <div className="tyt-wrap">
          ...
          <p className="tyt-hero-trial tyt-reveal">
            Not sure yet? <a href="https://buy.stripe.com/bJeeVc58p7Swdjr8ON1gs0d" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,.8)", fontWeight: 700, textDecoration: "underline" }}>Try it for $20 — one month trial →</a>
          </p>
      ...
      <section className="tyt-section-investment" id="tyt-checkout">
        <div className="tyt-wrap-wide">
          ...
          <h2 className="tyt-reveal" style={{ textAlign: "center" }}>Choose your plan.</h2>
          <p className="tyt-reveal" style={{ textAlign: "center", color: "var(--muted)", margin: "0 auto 48px", maxWidth: "52ch" }}>Same support, same access — every task handled, every month. Pick the commitment that works best for you.</p>

          {/* Includes strip */}
          <div className="tyt-reveal" style={{ background: "var(--soft)", borderRadius: 14, padding: "18px 28px", marginBottom: 32, maxWidth: 760, margin: "0 auto 32px" }}>
            <p style={{ textAlign: "center", fontSize: 13, fontWeight: 600, color: "var(--accent)", textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: 12 }}>Every plan includes</p>
            <div style={{ display: "flex", flexWrap: "wrap", gap: "8px 24px", justifyContent: "center" }}>
              {[
                "1–3 tech tasks/challenges per month",
                "Email & text support",
                "Co-working calls (30–60 min)",
                "3–5 day turnaround",
                "Kartra, GHL, Kajabi, ConvertKit & more",
              ].map(item => (
                <span key={item} style={{ fontSize: 13, color: "var(--dark)", display: "flex", alignItems: "center", gap: 6 }}>
          ...
          {/* Four plan cards */}
          <div className="tyt-reveal" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 20, maxWidth: 1080, margin: "0 auto 24px" }}>

            {/* Trial */}
            <div style={{ background: "var(--white)", border: "1px solid rgba(196,168,130,.3)", borderRadius: 20, padding: "32px 28px", display: "flex", flexDirection: "column" }}>
              <p style={{ fontFamily: "var(--font-caps)", fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.15em", color: "var(--muted)", marginBottom: 16 }}>Trial</p>
              <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 4 }}>
                <span style={{ fontFamily: "var(--font-display)", fontSize: 42, fontWeight: 700, color: "var(--dark)", lineHeight: 1 }}>$20</span>
                <span style={{ fontSize: 14, color: "var(--muted)" }}>/1 month</span>
              </div>
              <p style={{ fontSize: 12, color: "var(--muted)", marginBottom: 20 }}>One time · No renewal</p>
              <div style={{ height: 1, background: "rgba(196,168,130,.2)", marginBottom: 20 }} />
              <p style={{ fontSize: 14, color: "#555", lineHeight: 1.65, marginBottom: 28, flex: 1 }}>
                Want to see how it works before committing? One month, one task — no strings attached.
              </p>
              <a href="https://buy.stripe.com/bJeeVc58p7Swdjr8ON1gs0d" className="tyt-btn" style={{ display: "block", textAlign: "center", fontSize: 14, padding: "13px 24px", background: "var(--soft)", color: "var(--accent)", border: "1px solid rgba(61,114,103,.25)", borderRadius: 99, textDecoration: "none" }} target="_blank" rel="noopener noreferrer">
                Try for $20 →
              </a>
            </div>
            ...
            {/* Monthly */}
            <div style={{ background: "var(--white)", border: "1px solid rgba(196,168,130,.3)", borderRadius: 20, padding: "32px 28px", display: "flex", flexDirection: "column" }}>
              <p style={{ fontFamily: "var(--font-caps)", fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.15em", color: "var(--muted)", marginBottom: 16 }}>Monthly</p>
              <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 4 }}>
                <span style={{ fontFamily: "var(--font-display)", fontSize: 42, fontWeight: 700, color: "var(--dark)", lineHeight: 1 }}>$150</span>
                <span style={{ fontSize: 14, color: "var(--muted)" }}>/month</span>
              </div>
              <p style={{ fontSize: 12, color: "var(--muted)", marginBottom: 20 }}>Cancel anytime · No contract</p>
              <div style={{ height: 1, background: "rgba(196,168,130,.2)", marginBottom: 20 }} />
              <p style={{ fontSize: 14, color: "#555", lineHeight: 1.65, marginBottom: 28, flex: 1 }}>
                Best if you want to keep things flexible and roll month to month.
              </p>
              <a href={STRIPE_LINK} className="tyt-btn" style={{ display: "block", textAlign: "center", fontSize: 14, padding: "13px 24px", background: "var(--soft)", color: "var(--accent)", border: "1px solid rgba(61,114,103,.25)", borderRadius: 99, textDecoration: "none" }} target="_blank" rel="noopener noreferrer">
                Join Monthly →
              </a>
            </div>

            {/* 3 Months — featured */}
            <div style={{ background: "var(--dark)", border: "2px solid var(--light-accent)", borderRadius: 20, padding: "32px 28px", display: "flex", flexDirection: "column", position: "relative" }}>
              <div style={{ position: "absolute", top: -14, left: "50%", transform: "translateX(-50%)", background: "var(--light-accent)", color: "var(--dark)", fontFamily: "var(--font-caps)", fontWeight: 700, fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", padding: "4px 14px", borderRadius: 99, whiteSpace: "nowrap" }}>
                Save $100
              </div>
              <p style={{ fontFamily: "var(--font-caps)", fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.15em", color: "var(--light-accent)", marginBottom: 16 }}>3 Months</p>
              <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 4 }}>
                <span style={{ fontFamily: "var(--font-display)", fontSize: 42, fontWeight: 700, color: "#fff", lineHeight: 1 }}>$350</span>
                <span style={{ fontSize: 14, color: "rgba(255,255,255,.45)" }}>/3 months</span>
              </div>
              <p style={{ fontSize: 12, color: "rgba(255,255,255,.45)", marginBottom: 20 }}>~$117/mo · Save $100 vs monthly</p>
              <div style={{ height: 1, background: "rgba(255,255,255,.1)", marginBottom: 20 }} />
              <p style={{ fontSize: 14, color: "rgba(255,255,255,.7)", lineHeight: 1.65, marginBottom: 28, flex: 1 }}>
                Best if you have a launch, project, or backlog to work through over the next few months.
              </p>
              <a href={STRIPE_LINK} className="tyt-btn tyt-btn-primary" style={{ display: "block", textAlign: "center", fontSize: 14, padding: "13px 24px", borderRadius: 99, textDecoration: "none" }} target="_blank" rel="noopener noreferrer">
                Join for 3 Months →
              </a>
            </div>

            {/* Annual */}
            <div style={{ background: "var(--white)", border: "1px solid rgba(196,168,130,.3)", borderRadius: 20, padding: "32px 28px", display: "flex", flexDirection: "column", position: "relative" }}>
              <div style={{ position: "absolute", top: -14, left: "50%", transform: "translateX(-50%)", background: "var(--accent)", color: "#fff", fontFamily: "var(--font-caps)", fontWeight: 700, fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", padding: "4px 14px", borderRadius: 99, whiteSpace: "nowrap" }}>
                Best Value
              </div>
              <p style={{ fontFamily: "var(--font-caps)", fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.15em", color: "var(--muted)", marginBottom: 16 }}>Annual</p>
              <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 4 }}>
                <span style={{ fontFamily: "var(--font-display)", fontSize: 42, fontWeight: 700, color: "var(--dark)", lineHeight: 1 }}>$900</span>
                <span style={{ fontSize: 14, color: "var(--muted)" }}>/year</span>
              </div>
              <p style={{ fontSize: 12, color: "var(--accent)", fontWeight: 600, marginBottom: 20 }}>$75/mo · Save $900 vs monthly</p>
              <div style={{ height: 1, background: "rgba(196,168,130,.2)", marginBottom: 20 }} />
              <p style={{ fontSize: 14, color: "#555", lineHeight: 1.65, marginBottom: 28, flex: 1 }}>
                Best if you want to set it and forget it — one less thing on your plate for the whole year.
              </p>
              <a href={STRIPE_LINK} className="tyt-btn" style={{ display: "block", textAlign: "center", fontSize: 14, padding: "13px 24px", background: "var(--accent)", color: "#fff", borderRadius: 99, textDecoration: "none" }} target="_blank" rel="noopener noreferrer">
                Join for a Year →
              </a>
            </div>
          ...
          <p className="tyt-reveal" style={{ textAlign: "center", fontSize: 13, color: "var(--muted)", marginTop: 8 }}>
            Questions? Email <a href="mailto:arshtist@gmail.com" style={{ color: "var(--accent)" }}>arshtist@gmail.com</a>
          </p>
        </div>
      </section>
      ...
      <section className="tyt-section-final-cta">
        <div className="tyt-wrap">
          ...
          <div className="tyt-final-cta-stack tyt-reveal">
            <a href="#tyt-checkout" className="tyt-btn tyt-btn-primary" style={{ fontSize: "16px", padding: "18px 44px" }}>
              See plans →
            </a>
            <p style={{ color: "rgba(255,255,255,.4)", fontSize: "14px" }}>From $75/mo · or <a href="https://buy.stripe.com/bJeeVc58p7Swdjr8ON1gs0d" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,.65)", textDecoration: "underline" }}>try one month for $20</a></p>
          </div>
        </div>
      </section>
